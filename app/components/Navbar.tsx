        ...
        <nav aria-label = "Global" className = "mx-auto flex max-w-8xl items-center justify-between p-6 lg:px-8">
          ...
          <PopoverGroup className = "hidden lg:flex lg:gap-x-12">
            <Popover className = "relative">
              <PopoverButton
                  className = "px-2 py-1 rounded-md flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 hover:bg-gray-50 focus:outline-none"
              >
                {label.article}
                ...
                <div className = "p-4">
                  {products.map((item) => (
                      ...
                      >
                        ...
                        >
                          <item.icon
                              aria-hidden = "true" className = "h-6 w-6 text-gray-600 group-hover:text-indigo-600"
                          />
                        </div>
            ...
            <a
                href = "/photos/all/1"
                className = "px-2 py-1 rounded-md text-sm font-semibold leading-6 text-gray-900 hover:bg-gray-50 focus:outline-none"
            >
              {label.photography}
            </a>
            <a
