  ...
  return (
      <footer aria-labelledby="footer-heading" className="bg-white">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          ...
          >
            <div>
              <h3 className = "text-sm font-semibold leading-6 text-gray-900">{label.subscribe_title}</h3>
              <p className = "mt-2 text-sm leading-6 text-gray-600">
                {label.subscribe_description}
              </p>
            </div>
            {!actionResponse?.success ? (
                <Form method="POST" className = "mt-6 sm:flex sm:max-w-md lg:mt-0">
                  <div>
                    ...
                    <input
                        ...
                        type = "email"
                        required
                        placeholder = {label.subscribe_placeholder}
                        autoComplete = "email"
                ...
                <p className="text-sm text-green-600">{label.email_sent}</p>
            )}
          </div>
